...
function places_files() {
  wp_enqueue_script('googleMap', 'https://maps.googleapis.com/maps/api/js?key=AIzaSyC8mc_sAmQ_DksF_Pop2V7H3d1ItkL6D3w', NULL, '1.0', true);
...
// {
//     $api['key'] = 'AIzaSyC8mc_sAmQ_DksF_Pop2V7H3d1ItkL6D3w';    
//     return $api;
// }
